...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5">
      {/* Header */}
      <header className="border-b bg-card/80 dark:bg-background/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container flex h-16 items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-semibold text-foreground">CareBase</h1>
              <p className="text-xs text-muted-foreground">Home Care Operations Platform</p>
            </div>
          </div>
      ...
      <section className="container py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="border-border hover:border-emerald-300 transition-colors">
            <CardHeader>
      ...
      <section className="container py-16">
        <div className="text-center mb-12">
          <h3 className="text-2xl font-bold text-foreground mb-4">Supporting All Service Lines</h3>
          <p className="text-muted-foreground">Customized workflows for each program type</p>
        </div>
        <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center p-6 rounded-xl bg-card border border-border">
            <div className="text-3xl font-bold text-emerald-600 mb-2">OLTL</div>
            <p className="text-muted-foreground text-sm">Office of Long-Term Living</p>
          </div>
          <div className="text-center p-6 rounded-xl bg-card border border-border">
            <div className="text-3xl font-bold text-blue-600 mb-2">ODP</div>
            <p className="text-muted-foreground text-sm">Office of Developmental Programs</p>
          </div>
          <div className="text-center p-6 rounded-xl bg-card border border-border">
            <div className="text-3xl font-bold text-purple-600 mb-2">Skilled</div>
            <p className="text-muted-foreground text-sm">Licensed Professional Services</p>
          </div>
        </div>
      </section>
